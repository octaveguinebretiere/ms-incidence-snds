...
/* Program name : extract_hosp
/* Objective : 
extract hospital discharges with a diagnosis code for MS.

-> the 06-08 and 09-23 periods are trackled separaterly since the table names changed
/* Tables : output table: ms_pmsi_06_23 in the sasdata1 library
...
%let out_file_name_mco = ms_pmsi_09_23;
...
%let out_file_name_pmsi = ms_pmsi_06_09;
...
proc sql;
create table sasdata1.ms_pmsi_06_23 as
select ben_nir_psa, exe_soi_dtd
from sasdata1.ms_pmsi_06_09
union
select ben_nir_psa, exe_soi_dtd
from sasdata1.ms_pmsi_09_23
;
quit;
